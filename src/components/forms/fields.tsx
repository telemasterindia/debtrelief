...
const control =
  "block w-full rounded-[var(--radius-control)] border-2 bg-white px-4 text-lg text-ink placeholder:text-[#6b7789] transition-[border-color,box-shadow] focus:border-brand-600 focus:shadow-[0_0_0_4px_rgb(11_87_208/0.18)] focus:outline-none";
        ...
        {options.map((o, i) => {
          ...
          return (
            <label
              ...
              htmlFor={optionId}
              className={cn(
                "flex min-h-14 cursor-pointer items-center gap-3.5 rounded-[var(--radius-control)] border-2 bg-white px-4 py-3 text-lg text-ink transition-colors hover:border-ink has-[:checked]:border-brand-600 has-[:checked]:bg-brand-50 has-[:focus-visible]:shadow-[0_0_0_4px_rgb(11_87_208/0.25)]",
